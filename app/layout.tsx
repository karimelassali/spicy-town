...
export const metadata: Metadata = {
  ...
  description:
    "Spicy Town CSG è il miglior ristorante di cucina pakistana halal a Castel San Giovanni. Specialità in piatti tradizionali pakistani e sapori autentici. Vieni a trovarci!",
  icons: {
  ...
  openGraph: {
    ...
    description:
      "Prova i nostri piatti tradizionali pakistani e sapori autentici al ristorante Spicy Town CSG!",
  ...
  twitter: {
    ...
    description:
      "Piatti pakistani tradizionali, sapori autentici. Visita Spicy Town CSG ora!",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description:
      "Spicy Town CSG è un ristorante di cucina pakistana halal a Castel San Giovanni. Piatti tradizionali pakistani, sapori autentici e altro ancora.",
    address: {
      "@type": "PostalAddress",
  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable}`}>
      <body className="antialiased">
        {/* Google tag (gtag.js) */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-2Y60573900"
